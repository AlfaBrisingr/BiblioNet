...
--
-- Client :  localhost
-- Généré le :  Lun 18 Avril 2016 à 18:19
...
(8, '2070643026', 'Harry Potter - Tome 1 : Harry Potter à l''école des sorciers', 2, 10, '1998-11-16', '8.5', 'Le jour de ses onze ans, Harry Potter, un orphelin élevé par un oncle et une tante qui le détestent, voit son existence bouleversée. Un géant vient le chercher pour l''emmener à Poudlard, une école de sorcellerie !\r\nVoler en balai, jeter des sorts, combattre les trolls : Harry Potter se révèle un sorcier doué. Mais un mystère entoure sa naissance et l''effroyable V..., le mage dont personne n''ose prononcer le nom.', 'Français', 'Ressources/img/Livres/HarryPotter_Tome1.png', 2, 2),
...
(7, 'martin', 'jean', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'admin@admin.com', 'rue de la Jambe', '52140', 'Bisounours');
--
...
--
ALTER TABLE `Livre`
 ADD PRIMARY KEY (`NumLivre`), ADD KEY `NoEdition` (`NoEdition`), ADD KEY `NoGenre` (`NoGenre`);
...
--
ALTER TABLE `Auteur`
MODIFY `NumAuteur` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `Commande`
--
ALTER TABLE `Commande`
MODIFY `NumCommande` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2530;
--
-- AUTO_INCREMENT pour la table `Commentaire`
--
ALTER TABLE `Commentaire`
MODIFY `NumCom` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1;
--
-- AUTO_INCREMENT pour la table `Edition`
--
ALTER TABLE `Edition`
MODIFY `NumEdition` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `Genre`
--
ALTER TABLE `Genre`
MODIFY `NumGenre` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `Livre`
--
ALTER TABLE `Livre`
MODIFY `NumLivre` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT pour la table `Utilisateur`
--
ALTER TABLE `Utilisateur`
MODIFY `NumUser` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
